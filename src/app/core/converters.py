...
def decimal_to_binary(decimal_str: str) -> str:
    ...
    :param decimal_str: The decimal number as a string.
...
def binary_to_decimal(binary_str: str) -> str:
    """Converts a binary string to a decimal string.

    :param binary_str: The binary number as a string.
...
def decimal_to_octal(decimal_str: str) -> str:
...
def octal_to_decimal(octal_str: str) -> str:
    """Converts an octal string to a decimal string.

    :param octal_str: The octal number as a string.
    :return: The decimal representation as a string.
    :raises ValueError: If the input is not a valid octal string.
    """
    try:
...
def decimal_to_hexadecimal(decimal_str: str) -> str:
...
def hexadecimal_to_decimal(hex_str: str) -> str:
    """Converts a hexadecimal string to a decimal string.

    :param hex_str: The hexadecimal number as a string.
    :return: The decimal representation as a string.
    :raises ValueError: If the input is not a valid hexadecimal string.
    """
    try:
...
def decimal_to_custom_base(decimal_str: str, base: int) -> str:
    """Converts a decimal string to a string in a custom base (2-62).

    :param decimal_str: The decimal number as a string.
    :param base: The target base (integer between 2 and 62).
    :return: The number represented in the custom base.
    :raises ValueError: If inputs are invalid or the base is out of range.
    """
    try:
        n = int(decimal_str)
    except Exception:
...
def custom_base_to_decimal(number_str: str, base: int) -> str:
    """Converts a number string from a custom base to a decimal string.

    :param number_str: The number in the custom base as a string.
    :param base: The base of the input number (integer between 2 and 62).
    :return: The decimal representation as a string.
    :raises ValueError: If inputs are invalid or the number string contains
...
def morse_to_text(morse_code: str) -> str:
    ...
    :param morse_code: The Morse code string.
...
def braille_to_text(braille_code: str) -> str:
    """Converts a Braille string back to text.

    :param braille_code: The Braille string.
    :return: The decoded text.
    :raises ValueError: On conversion failure.
    """
    try:
...
def rot_n_encrypt(text: str, n: int) -> str:
    """Encrypts text using the ROT-N (Caesar) cipher.

    :param text: The plaintext to encrypt.
    :param n: The integer shift value.
    :return: The encrypted ciphertext.
    :raises ValueError: If n is not a valid integer.
    """
    n = int(n)
    result = []
    for char in text:
...
def rot_n_decrypt(text: str, n: int) -> str:
    """Decrypts text from the ROT-N (Caesar) cipher.

    :param text: The ciphertext to decrypt.
    :param n: The integer shift value used for encryption.
...
def text_to_grid_cipher(text: str) -> str:
    """Converts a text string to the Grid (Pigpen) cipher.

    :param text: The input text string.
    :return: The Grid cipher representation.
    :raises ValueError: On conversion failure.
    """
    try:
        text = text.upper()
...
def grid_cipher_to_text(grid_cipher: str) -> str:
    """Converts a Grid Cipher string back to text.

    :param grid_cipher: The Grid cipher string.
    :return: The decoded text.
    :raises ValueError: On conversion failure.
    """
    try:
...
def text_to_emoji(text: str) -> str:
    ...
    :param text: The input text string.
    :return: The Emoji cipher representation.
...
def emoji_to_text(cipher_text: str) -> str:
    """Converts an Emoji cipher string back to text.

    :param cipher_text: The Emoji cipher string.
    :return: The decoded text.
    :raises Exception: On conversion failure.
    """
    try:
...
def _parse_affine_key(key) -> tuple[int, int]:
    """Parses an affine cipher key from various input formats.

    :param key: The key in string, tuple, or list format.
    :return: A tuple (a, b) representing the affine key.
...
def affine_encrypt(text: str, key=None) -> str:
    ...
    :param text: The plaintext to encrypt.
    :param key: The affine key (a, b).
    :return: The encrypted ciphertext.
    :raises ValueError: If the key is invalid or encryption fails.
    """
    try:
...
def affine_decrypt(cipher_text: str, key=None) -> str:
    ...
    :param key: The affine key (a, b) used for encryption.
    :return: The decrypted plaintext.
    :raises ValueError: If the key is invalid or decryption fails.
    """
    try:
        a, b = _parse_affine_key(key)
        a = int(a)
...
def ascii_encode(text: str) -> str:
    """Converts a string to a space-separated string of ASCII values.

    :param text: The input string.
    :return: A string of ASCII values.
    :raises ValueError: If the text contains non-ASCII characters or if
                        encoding fails.
    """
    try:
        codes = []
...
def ascii_decode(ascii_str: str) -> str:
    """Converts a space-separated string of ASCII values back to a string.

    :param ascii_str: The string of ASCII values.
    :return: The decoded string.
    :raises ValueError: If decoding fails (e.g., invalid number format).
    """
    try:
...
def iso_n_encode(text: str, encoding: str = "iso-8859-1", n: int = None) -> str:
    """Encodes text using an ISO encoding with an optional ROT-N shift, then Base64 encodes.

    :param text: The input text.
    :param encoding: The ISO encoding standard (e.g., "iso-8859-1").
    :param n: An optional integer shift to apply to each character's byte value.
...
def iso_n_decode(encoded: str, encoding: str = "iso-8859-1", n: int = None) -> str:
    """Decodes a Base64 string, then decodes from an ISO encoding with an optional ROT-N shift.

    :param encoded: The Base64 encoded string.
    :param encoding: The ISO encoding standard (e.g., "iso-8859-1").
    :param n: An optional integer shift to reverse.
    :return: The decoded text.
    :raises ValueError: On decoding failure.
    """
    try:
...
def utf_n_encode(text: str, encoding: str = "utf-8", n: int = None) -> str:
    """Encodes text using a UTF encoding with an optional ROT-N shift, then Base64 encodes.

    :param text: The input text.
    :param encoding: The UTF encoding standard (e.g., "utf-8").
    :param n: An optional integer shift to apply to each character's ordinal value.
    :return: The Base64 encoded string.
    :raises ValueError: On encoding failure.
    """
    try:
...
def utf_n_decode(encoded: str, encoding: str = "utf-8", n: int = None) -> str:
    """Decodes a Base64 string, then decodes from a UTF encoding with an optional ROT-N shift.
...
def int_to_base(n: int, alphabet: str) -> str:
    """Converts an integer to a string representation in a custom base.

    :param n: The integer to convert.
    :param alphabet: The string of characters to use as the base.
...
def base_to_int(s: str, alphabet: str) -> int:
    """Converts a string in a custom base to an integer.

    :param s: The string representation of the number.
    :param alphabet: The alphabet used for the base.
...
def word_to_basen(text: str, base: int) -> str:
    """Encodes a text string into a specified base.

    :param text: The text to encode.
    :param base: The target base (2, 8, 10, 16, 32, 36, 58, 62, 64, 85, or -1 for URL-safe Base64).
    :return: The encoded string.
    :raises ValueError: If an unsupported base is provided.
    """
...
def basen_to_word(encoded: str, base: int) -> str:
    """Decodes a string from a specified base back to text.

    :param encoded: The encoded string.
    :param base: The base of the encoded string.
    :return: The decoded text.
    :raises ValueError: If an unsupported base is provided or decoding fails.
    """
...
def pad_data(data: bytes, block_size: int = 128) -> bytes:
    ...
    :param block_size: The block size in bits for the cipher.
...
def aes_encrypt(text: str, password: str) -> str:
    """Encrypts text using AES-256-CBC with a password-derived key.
...
def chacha20_encrypt(text: str, password: str) -> str:
    ...
    :param text: The plaintext to encrypt.
    :param password: The password to derive the key from.
    :return: A Base64 encoded string containing salt, nonce, and ciphertext.
    """
    salt = os.urandom(16)
    key = derive_key(password, salt, 32)
    nonce = os.urandom(16)
...
def triple_des_decrypt(ciphertext_b64: str, password: str) -> str:
    """Decrypts 3DES-encrypted ciphertext using a password.
...
def blowfish_encrypt(text: str, password: str) -> str:
    """Encrypts text using the Blowfish algorithm with a password.
...
def rsa_generate_keys(password: str = None, key_size: int = 2048) -> tuple[str, str]:
    """Generates RSA private and public keys.

    :param password: An optional password to encrypt the private key.
    :param key_size: The key size in bits (e.g., 2048, 4096).
    :return: A tuple containing the private key PEM and public key PEM as strings.
    """
...
def rsa_encrypt(text: str, public_key_pem: str) -> str:
    """Encrypts text using an RSA public key (hybrid encryption with AES-GCM).

    :param text: The plaintext to encrypt.
    :param public_key_pem: The PEM-encoded RSA public key.
    :return: A Base64 encoded string containing the encrypted components.
    """
...
def rsa_decrypt(ciphertext_b64: str, private_key_pem: str, password: str = None) -> str:
    ...
    :param ciphertext_b64: The Base64 encoded ciphertext from rsa_encrypt.
    :param private_key_pem: The PEM-encoded RSA private key.
    :param password: The password for the private key, if it's encrypted.
    :return: The decrypted plaintext.
    """
...
def rsa_sign(text: str, private_key_pem: str, password: str = None) -> str:
    ...
    :param private_key_pem: The PEM-encoded RSA private key.
    :param password: The password for the private key, if encrypted.
...
def rsa_verify(text: str, signature_b64: str, public_key_pem: str) -> bool:
    ...
    :param signature_b64: The Base64 encoded signature to verify.
    :param public_key_pem: The PEM-encoded RSA public key.
...
def ecc_generate_keys(curve_name: str = "SECP256R1") -> tuple[str, str]:
    """Generates ECC private and public keys for a given curve.

    :param curve_name: The name of the ECC curve to use.
    :return: A tuple containing the private key PEM and public key PEM as strings.
    """
    curve_map = {
...
def ecc_encrypt(plaintext: str, public_pem: str) -> str:
    ...
    :param public_pem: The PEM-encoded ECC public key.
...
def ecc_decrypt(ciphertext_b64: str, private_pem: str) -> str:
    ...
    :param ciphertext_b64: The Base64 encoded ciphertext.
    :param private_pem: The PEM-encoded ECC private key.
    :return: The decrypted plaintext.
...
def elgamal_generate_keys(key_size: int = 2048) -> tuple[str, str]:
    """
    Generates ElGamal-like keys using Diffie-Hellman.

    This uses standard, hardcoded DH parameters for speed and reliability.
    :param key_size: The key size (ignored, uses 2048-bit group).
    :return: A tuple of (private_key_pem, public_key_pem).
    :raises ValueError: On key generation failure.
    """
    try:
...
def elgamal_encrypt(plaintext: str, public_pem: str) -> str:
    """Encrypts text using an ElGamal/DH public key (DHIES).

    :param plaintext: The text to encrypt.
    :param public_pem: The PEM-encoded public key.
    :return: The Base64 encoded ciphertext.
    :raises ValueError: On encryption failure.
    """
    try:
...
def elgamal_decrypt(ciphertext_b64: str, private_pem: str) -> str:
    """Decrypts text using an ElGamal/DH private key (DHIES).

    :param ciphertext_b64: The Base64 encoded ciphertext.
    :param private_pem: The PEM-encoded private key.
    :return: The decrypted plaintext.
    :raises ValueError: On decryption failure.
    """
    try:
...
def _wrap_base64_body(body: str, header: str) -> str:
    ...
    :param body: The Base64 string body.
    :param header: The header text (e.g., "PUBLIC KEY").
...
def parse_pem_and_type(key_text: str) -> tuple[str, str]:
    """Parses a string to identify and format it as a PEM key.

    Determines if the key is public or private.
    :param key_text: The key text, which can be a raw Base64 string or a
                     full PEM block.
    :return: A tuple of (formatted_pem_string, key_type), where key_type is
             'public' or 'private'.
...
def bcrypt_hash(text: str) -> str:
    ...
    :param text: The input string.
    :return: The full bcrypt hash string including salt and parameters.
    """
    try:
        salt = bcrypt.gensalt()
...
def scrypt_hash(text: str, salt: bytes = None) -> str:
    ...
    :param text: The input string.
    :param salt: An optional salt; if not provided, a new one is generated.
    :return: The hex-encoded scrypt hash.
    """
    try:
        if salt is None:
            salt = bcrypt.gensalt()
...
def argon2_hash(text: str) -> str:
    ...
    :param text: The input string.
    :return: The full Argon2 hash string including salt and parameters.
    """
    try:
        return ph.hash(text)
    except Exception as e:
...
def md5_checksum(text: str) -> str:
    ...
    :raises ValueError: If the input is empty or checksum fails.
    """
    try:
        if not text:
...
def crc32_checksum(text: str) -> str:
    ...
    :param text: The input string.
    :return: The hex-encoded CRC32 checksum.
    :raises ValueError: If the input is empty or checksum fails.
    """
    try:
        if not text:
...
def adler32_checksum(text: str) -> str:
    ...
    :param text: The input string.
    :return: The hex-encoded Adler-32 checksum.
    :raises ValueError: If the input is empty or checksum fails.
    """
    try:
        if not text:
...
def convert_color(color_input: str, target_format: str) -> str:
    """Converts a color from one format to another.

    :param color_input: The color as a string (e.g., "#FF0000", "red", "rgb(255,0,0)").
    :param target_format: The desired output format (e.g., "HEX", "RGB", "Name").
...
def convert_length(value: float, from_unit: str, to_unit: str) -> float:
    ...
    :param from_unit: The starting unit.
...
def convert_temperature(value: float, from_unit: str, to_unit: str) -> float:
    ...
    :param value: The numeric value to convert.
    :param from_unit: The starting unit ('C', 'K', 'F').
    :param to_unit: The target unit ('C', 'K', 'F').
    :return: The converted value.
    """
...
def convert_digital(value: float, from_unit: str, to_unit: str) -> float:
...
def unit_converter(value: str, category: str, from_unit: str, to_unit: str) -> str:
    ...
    :param category: The category of unit (e.g., "Length", "Mass").
    :param from_unit: The starting unit.
    :param to_unit: The target unit.
    :return: The converted value as a string, or an error message.
    """
    try:
        value = float(value)
        converters = {
...
def integer_to_roman(n: str) -> str:
    """Converts an integer to a Roman numeral string.

    :param n: The integer as a string.
    :return: The Roman numeral representation.
    :raises ValueError: If the number is out of the valid range (1-3999) or
...
def roman_to_integer(s: str) -> str:
    ...
    :raises ValueError: If the Roman numeral string is invalid.
    """
    try:
...
def text_to_ascii_art(text: str, font: str = 'standard') -> str:
    ...
    :param font: The name of the pyfiglet font to use.
    :return: The generated ASCII art as a string, or an error message.
    """
    try:
