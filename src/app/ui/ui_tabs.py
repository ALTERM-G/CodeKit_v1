...
def setup_tabs_widget(window_instance, tabs_info, base_placeholder="Base", parent_widget=None, menu_name=None):
    ...
    for name, placeholder in tabs_info:
        ...
        if any(keyword in name for keyword in UI_KEYWORDS_WITH_BASE) and name not in ["Divisibility Checker"]:
            ...
            line_edit_style = DARK_MODE_STYLES["line_edit"] if is_dark else STYLES["line_edit"]

            line_edit = window_instance.widget_factory.create_line_edit(w=590, h=45, style=line_edit_style, placeholder=translated_placeholder, parent=widget)
            ...
            if name == "Custom":
                ...
                base_input = window_instance.widget_factory.create_line_edit(w=100, h=45, style=line_edit_style, placeholder=base_placeholder)

            window_instance.line_edits.append(base_input)
            ...
            if "Generate" in name:
                ...
                is_dark = window_instance.settings.get("dark_mode", False)
                # Use the correct style based on the theme
                text_edit_style = DARK_MODE_STYLES["text_edit"] if is_dark else STYLES["text_edit_light"]

                line_edit = window_instance.widget_factory.create_line_edit(
                    style=text_edit_style, text_edit=True, w=345, h=150, placeholder=translated_placeholder, parent=widget)
                ...
                base_input = window_instance.widget_factory.create_line_edit(
                    style=text_edit_style, text_edit=True, w=345, h=150, placeholder=placeholder_text, parent=widget)
            ...
            is_dark = window_instance.settings.get("dark_mode", False)
            line_edit_style = DARK_MODE_STYLES["line_edit"] if is_dark else STYLES["line_edit"]
            line_edit = window_instance.widget_factory.create_line_edit(w=550, h=45, style=line_edit_style, placeholder=translated_placeholder, parent=widget)
            line_edit.move(start_x, y_pos)
            window_instance.line_edits.append(line_edit)
            ...
            is_dark = window_instance.settings.get("dark_mode", False)
            line_edit_style = DARK_MODE_STYLES["line_edit"] if is_dark else STYLES["line_edit"]
            line_edit = window_instance.widget_factory.create_line_edit(w=490, h=45, style=line_edit_style, placeholder=translated_placeholder, parent=widget)
            line_edit.move(start_x, y_pos)
            window_instance.line_edits.append(line_edit)
            ...
            line_edit = window_instance.widget_factory.create_line_edit(style=text_edit_style, text_edit=True, w=700, h=170, placeholder=translated_placeholder, parent=widget)
            line_edit.move(start_x, y_pos)
            ...
            if name == "Divisibility Checker":
                line_edit = window_instance.widget_factory.create_line_edit(w=590, h=45, style=line_edit_style, placeholder=window_instance.tr("Enter Number"), parent=widget)
                line_edit.move(start_x, y_pos)
                window_instance.line_edits.append(line_edit)
                base_input = window_instance.widget_factory.create_line_edit(w=100, h=45, style=line_edit_style, placeholder=window_instance.tr("Divider"), parent=widget)
                base_input.move(start_x + 600, y_pos)
                window_instance.line_edits.append(base_input)
            else:
                base_input = None
                line_edit = window_instance.widget_factory.create_line_edit(style=line_edit_style, placeholder=translated_placeholder, parent=widget)
                line_edit.move(start_x, y_pos)
