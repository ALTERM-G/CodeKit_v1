...
def setup_cipher_detection_page(window_instance):
    ...
    window_instance.cipher_detection_input = window_instance.widget_factory.create_line_edit(style=STYLES["text_edit"], text_edit=True, w=700, h=170, placeholder=window_instance.tr("Enter Text"))
...
def apply_cipher_detection_theme(window_instance):
    ...
    if dark_mode:
        ...
        window_instance.cipher_detection_input.setStyleSheet(STYLES["text_edit_light"])
